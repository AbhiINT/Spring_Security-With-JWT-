...
public class UserController {
    ...
    @PostMapping("/setAuthorization/{id}")
    @PreAuthorize("hasAuthority('ADMIN_ROLES')")
    public String setAuthorizationLevel(@PathVariable Integer id, @RequestParam("authorizationLevel") String authorizationLevel) {
        
       userInfoService.setAuthorizationLevel(id, authorizationLevel);
        
       

        return "Authorization level updated successfully for user with ID: " + id;
    }
}
